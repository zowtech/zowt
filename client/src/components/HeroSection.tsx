...
import { Shield, Search, Lock, Eye, Fingerprint, Database, Wifi, Activity, DollarSign, Cpu, Zap, Coins } from 'lucide-react';
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-64 right-40 text-amber-400/20 animate-pulse-slow" style={{ animationDelay: '6s' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-6 text-white text-shadow-lg animate-fadeInUp font-mono" style={{ animationDelay: '0.2s' }}>
          {t('hero.headline')}
        </h1>
