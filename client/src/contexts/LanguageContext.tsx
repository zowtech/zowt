...
const translations = {
  ...
  en: {
    ...
    'cases.financial.desc': 'Investigation of $160k diverted via Bitcoin and stablecoins',
    ...
    'cases.corruption.desc': 'Analysis revealed $350k in bribes between employees',
