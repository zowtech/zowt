...
const translations = {
  pt: {
    ...
    'cases.deepfake.desc': 'Verificação técnica e análise forense de áudio deepfake usado para autorizar transferência fraudulenta de R$ 120k, com identificação dos softwares utilizados',
    ...
    'cases.corruption.desc': 'Análise forense de dispositivos móveis e sistemas corporativos revelou esquema de propinas totalizando R$ 1.8M entre funcionários públicos e empresários',
    ...
    'cases.social.title': 'Perfis Falsos Políticos',
    'cases.social.desc': 'Mapeamento completo de rede de 200 perfis falsos utilizados em ataques coordenados durante período eleitoral, com análise de metadados e padrões comportamentais',
    'cases.extortion.title': 'Doxing e Extorsão',
    'cases.extortion.desc': 'Investigação de caso complexo envolvendo vazamento direcionado de dados pessoais para fins de chantagem, com rastreamento digital dos perpetradores',
  ...
  en: {
    ...
    'cases.deepfake.desc': 'Technical verification and forensic analysis of deepfake audio used to authorize fraudulent transfer of $30k, with identification of software used',
    ...
    'cases.corruption.desc': 'Forensic analysis of mobile devices and corporate systems revealed bribery scheme totaling $450k between public officials and businessmen',
    ...
    'cases.social.title': 'Political Fake Profiles',
    'cases.social.desc': 'Complete mapping of network of 200 fake profiles used in coordinated attacks during electoral period, with metadata analysis and behavioral patterns',
    'cases.extortion.title': 'Doxing and Extortion',
    'cases.extortion.desc': 'Investigation of complex case involving targeted personal data leak for blackmail purposes, with digital tracking of perpetrators',
    'cases.insider.title': 'Insider Trading',
