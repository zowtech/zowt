...
const translations = {
  pt: {
    ...
    'cases.financial.title': 'Fraude Bancária Digital',
    'cases.financial.desc': 'Investigação de transações suspeitas em contas empresariais',
    'cases.identity.title': 'Roubo de Identidade',
    'cases.identity.desc': 'Análise de dispositivos para identificar vazamento de dados',
    'cases.hacking.title': 'Invasão de Sistema',
    'cases.hacking.desc': 'Perícia em servidor comprometido por acesso não autorizado',
    'cases.deepfake.title': 'Manipulação de Mídia',
    'cases.deepfake.desc': 'Verificação de autenticidade de arquivos de áudio e vídeo',
    'cases.crypto.title': 'Rastreamento de Criptomoedas',
    'cases.crypto.desc': 'Análise de transações blockchain para identificar origem',
    'cases.corruption.title': 'Investigação Corporativa',
    'cases.corruption.desc': 'Due diligence em processos internos e compliance',
    'cases.data.title': 'Vazamento de Dados',
    'cases.data.desc': 'Investigação de breach em base de dados corporativa',
    'cases.social.title': 'Análise de Redes Sociais',
    'cases.social.desc': 'Investigação de perfis e atividades suspeitas online',
    'cases.extortion.title': 'Extorsão Digital',
    'cases.extortion.desc': 'Rastreamento de ameaças e chantagens eletrônicas',
    'cases.insider.title': 'Investigação Interna',
    'cases.insider.desc': 'Análise de atividades suspeitas de funcionários',
  ...
  en: {
    ...
    'cases.financial.title': 'Digital Banking Fraud',
    'cases.financial.desc': 'Investigation of suspicious transactions in corporate accounts',
    'cases.identity.title': 'Identity Theft',
    'cases.identity.desc': 'Device analysis to identify data breach sources',
    'cases.hacking.title': 'System Intrusion',
    'cases.hacking.desc': 'Forensic analysis of compromised server systems',
    'cases.deepfake.title': 'Media Manipulation',
    'cases.deepfake.desc': 'Authenticity verification of audio and video files',
    'cases.crypto.title': 'Cryptocurrency Tracking',
    'cases.crypto.desc': 'Blockchain transaction analysis to identify origins',
    'cases.corruption.title': 'Corporate Investigation',
    'cases.corruption.desc': 'Due diligence on internal processes and compliance',
    'cases.data.title': 'Data Breach',
    'cases.data.desc': 'Investigation of corporate database security incident',
    'cases.social.title': 'Social Media Analysis',
    'cases.social.desc': 'Investigation of suspicious online profiles and activities',
    'cases.extortion.title': 'Digital Extortion',
    'cases.extortion.desc': 'Tracking of electronic threats and blackmail attempts',
    'cases.insider.title': 'Internal Investigation',
    'cases.insider.desc': 'Analysis of suspicious employee activities',
