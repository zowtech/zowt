...
const translations = {
  pt: {
    ...
    'cases.financial.title': 'Ransomware Bancário',
    'cases.financial.desc': 'Análise de ataque que criptografou sistemas de 3 agências',
    'cases.identity.title': 'Deepfake Financeiro',
    'cases.identity.desc': 'Investigação de vídeo falso usado em golpe de R$ 450k',
    'cases.hacking.title': 'APT Corporate',
    'cases.hacking.desc': 'Rastreamento de grupo persistente em multinacional por 8 meses',
    'cases.deepfake.title': 'Lavagem via NFTs',
    'cases.deepfake.desc': 'Análise de esquema que movimentou R$ 2.8M em criptomoedas',
    'cases.crypto.title': 'Sequestro Virtual',
    'cases.crypto.desc': 'Perícia técnica identificou autores via metadados telefônicos',
    'cases.corruption.title': 'Insider Trading',
    'cases.corruption.desc': 'Análise revelou uso de informações privilegiadas em ações',
    'cases.data.title': 'Espionagem Industrial',
    'cases.data.desc': 'Investigação de roubo de propriedade intelectual avaliada em R$ 5M',
    'cases.social.title': 'Manipulação Eleitoral',
    'cases.social.desc': 'Mapeamento de rede de 500 bots em campanha de desinformação',
    'cases.extortion.title': 'Sextortion Internacional',
    'cases.extortion.desc': 'Rastreamento de criminosos que extorquiram 40 vítimas',
    'cases.insider.title': 'Fraude Processual',
    'cases.insider.desc': 'Análise forense revelou adulteração de documentos judiciais',
  ...
  en: {
    ...
    'cases.financial.title': 'Banking Ransomware',
    'cases.financial.desc': 'Analysis of attack that encrypted systems in 3 bank branches',
    'cases.identity.title': 'Financial Deepfake',
    'cases.identity.desc': 'Investigation of fake video used in $115k fraud scheme',
    'cases.hacking.title': 'Corporate APT',
    'cases.hacking.desc': 'Tracking persistent threat group in multinational for 8 months',
    'cases.deepfake.title': 'NFT Money Laundering',
    'cases.deepfake.desc': 'Analysis of scheme that moved $700k in cryptocurrencies',
    'cases.crypto.title': 'Virtual Kidnapping',
    'cases.crypto.desc': 'Technical analysis identified perpetrators via phone metadata',
    'cases.corruption.title': 'Insider Trading',
    'cases.corruption.desc': 'Analysis revealed use of privileged information in stock trades',
    'cases.data.title': 'Industrial Espionage',
    'cases.data.desc': 'Investigation of intellectual property theft valued at $1.2M',
    'cases.social.title': 'Electoral Manipulation',
    'cases.social.desc': 'Mapping network of 500 bots in disinformation campaign',
    'cases.extortion.title': 'International Sextortion',
    'cases.extortion.desc': 'Tracking criminals who extorted 40 victims across countries',
    'cases.insider.title': 'Judicial Fraud',
    'cases.insider.desc': 'Forensic analysis revealed tampering of court documents',
