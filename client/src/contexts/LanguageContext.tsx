...
const translations = {
  pt: {
    ...
    'terms.section1.content': 'Ao utilizar os serviços da ZowT, você concorda com estes termos de uso. Se não concordar, não utilize nossos serviços.',
  ...
  en: {
    ...
    'terms.section1.content': 'By using ZowT services, you agree to these terms of use. If you do not agree, do not use our services.',
