...
const translations = {
  pt: {
    ...
    'cases.financial.desc': 'Investigação de R$ 850k em transações suspeitas via PIX',
    'cases.identity.title': 'Roubo de Identidade',
    'cases.identity.desc': 'Análise forense revelou 15k CPFs comprometidos',
    'cases.hacking.title': 'Invasão de Sistema',
    'cases.hacking.desc': 'Perícia em ransomware que afetou 200 workstations',
    'cases.deepfake.title': 'Manipulação de Mídia',
    'cases.deepfake.desc': 'Verificação de áudio falso usado em fraude de R$ 120k',
    'cases.crypto.title': 'Rastreamento de Criptomoedas',
    'cases.crypto.desc': 'Rastreamento de 45 Bitcoins através de múltiplas wallets',
    'cases.corruption.title': 'Investigação Corporativa',
    'cases.corruption.desc': 'Due diligence revelou desvio de R$ 2.3M em licitação',
    'cases.data.title': 'Vazamento de Dados',
    'cases.data.desc': 'Investigação de breach com exposição de 80k registros',
    'cases.social.title': 'Análise de Redes Sociais',
    'cases.social.desc': 'Mapeamento de 150 perfis falsos em esquema coordenado',
    'cases.extortion.title': 'Extorsão Digital',
    'cases.extortion.desc': 'Investigação de chantagem por R$ 50k via telegram',
    'cases.insider.title': 'Investigação Interna',
    'cases.insider.desc': 'Análise provou venda de dados por funcionário',
  ...
  en: {
    ...
    'cases.financial.desc': 'Investigation of $160k in suspicious PIX transactions',
    'cases.identity.title': 'Identity Theft',
    'cases.identity.desc': 'Forensic analysis revealed 15k compromised tax IDs',
    'cases.hacking.title': 'System Intrusion',
    'cases.hacking.desc': 'Ransomware analysis affecting 200 workstations',
    'cases.deepfake.title': 'Media Manipulation',
    'cases.deepfake.desc': 'Verification of fake audio used in $25k fraud',
    'cases.crypto.title': 'Cryptocurrency Tracking',
    'cases.crypto.desc': 'Traced 45 Bitcoins through multiple wallets',
    'cases.corruption.title': 'Corporate Investigation',
    'cases.corruption.desc': 'Due diligence revealed $450k embezzlement in bidding',
    'cases.data.title': 'Data Breach',
    'cases.data.desc': 'Investigation of breach exposing 80k records',
    'cases.social.title': 'Social Media Analysis',
    'cases.social.desc': 'Mapped 150 fake profiles in coordinated scheme',
    'cases.extortion.title': 'Digital Extortion',
    'cases.extortion.desc': 'Investigation of $10k telegram blackmail case',
    'cases.insider.title': 'Internal Investigation',
    'cases.insider.desc': 'Analysis proved employee data selling activities',
