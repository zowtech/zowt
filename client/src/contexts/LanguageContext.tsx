...
const translations = {
  pt: {
    ...
    'cases.deepfake.desc': 'Análise forense de vídeo deepfake utilizado em golpe de investimento falso, resultando em prejuízo de R$ 180k para múltiplas vítimas através de plataforma simulada',
    ...
    'cases.corruption.desc': 'Perícia digital revelou esquema de superfaturamento em licitação pública envolvendo R$ 2.4M, com análise de comunicações criptografadas e transações bancárias suspeitas',
    ...
    'cases.social.title': 'Políticos e Golpes Marketplace',
    'cases.social.desc': 'Investigação de rede criminosa que utilizava perfis falsos de políticos para aplicar golpes em marketplaces, lesando mais de 150 vítimas em esquema de produtos inexistentes',
    'cases.extortion.title': 'Doxing e Extorsão',
    'cases.extortion.desc': 'Investigação em servidor Discord revelou grupo de extorsão que ameaçava 35 vítimas com vazamento de dados íntimos, criminosos localizados através de análise de metadados',
  ...
  en: {
    ...
    'cases.deepfake.desc': 'Forensic analysis of deepfake video used in fake investment scam, resulting in $45k loss to multiple victims through simulated platform',
    ...
    'cases.corruption.desc': 'Digital forensics revealed overpricing scheme in public bidding involving $600k, with analysis of encrypted communications and suspicious bank transactions',
    ...
    'cases.social.title': 'Politicians & Marketplace Scams',
    'cases.social.desc': 'Investigation of criminal network using fake politician profiles to commit marketplace fraud, affecting over 150 victims in non-existent product schemes',
    'cases.extortion.title': 'Doxing and Extortion',
    'cases.extortion.desc': 'Investigation in Discord server revealed extortion group threatening 35 victims with intimate data leaks, criminals located through metadata analysis',
    'cases.insider.title': 'Insider Trading',
