...
const translations = {
  pt: {
    ...
    'services.diligence.title': 'Due Diligence Corporativa Completa',
    'services.diligence.desc': 'Investigação abrangente de ativos, reputação, histórico corporativo e conformidade regulatória',
    ...
    'services.profiling.title': 'OSINT, SOC & HUMINT',
    'services.profiling.desc': 'Rastreamento digital avançado, operações de centro de segurança e inteligência humana',
    ...
    'services.aml.title': 'AML/CFT Compliance Internacional',
    'services.aml.desc': 'Implementação de programas anti-lavagem corporativos e compliance regulatório global',
  ...
  en: {
    ...
    'services.diligence.title': 'Complete Corporate Due Diligence',
    'services.diligence.desc': 'Comprehensive investigation of assets, reputation, corporate history and regulatory compliance',
    ...
    'services.profiling.title': 'OSINT, SOC & HUMINT',
    'services.profiling.desc': 'Advanced digital tracking, security operations center activities and human intelligence',
    'services.blockchain.title': 'Blockchain Analytics',
    'services.blockchain.desc': 'Cryptocurrency tracking and blockchain transaction analysis',
    'services.aml.title': 'International AML/CFT Compliance',
    'services.aml.desc': 'Corporate anti-money laundering program implementation and global regulatory compliance',
    'services.sar.title': 'SAR & FATF Reporting',
