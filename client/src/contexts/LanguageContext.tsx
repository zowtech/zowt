...
const translations = {
  pt: {
    ...
    'cases.financial.desc': 'Investigação de R$ 850k desviados via Bitcoin e stablecoins',
    ...
    'cases.hacking.desc': 'Perícia em campanha que comprometeu 85 executivos',
    ...
    'cases.crypto.desc': 'Investigação de esquema de clonagem via grupos do Telegram',
    'cases.corruption.title': 'Investigação Anti-Corrupção',
    'cases.corruption.desc': 'Análise revelou propinas de R$ 1.8M entre funcionários',
  ...
  en: {
    ...
    'cases.financial.desc': 'Investigation of $215k diverted via Bitcoin and stablecoins',
    ...
    'cases.hacking.desc': 'Analysis of campaign that compromised 85 executives',
    'cases.deepfake.title': 'Media Manipulation',
    'cases.deepfake.desc': 'Verification of fake audio used in $30k fraud',
    'cases.crypto.title': 'Credit Card Fraud',
    'cases.crypto.desc': 'Investigation of cloning scheme via Telegram groups',
    'cases.corruption.title': 'Anti-Corruption Investigation',
    'cases.corruption.desc': 'Analysis revealed $450k in bribes between employees',
    ...
    'cases.insider.title': 'Insider Trading',
    'cases.insider.desc': 'Analysis proved employee fraud with $80k embezzlement',
