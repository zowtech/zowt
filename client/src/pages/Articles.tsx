...
export default function Articles() {
  ...
  const articles = [
    ...
    {
      id: 4,
      title: 'Investigação de Ataques DDoS: Metodologia Forense',
      excerpt: 'Análise técnica completa para identificar autores de ataques distribuídos de negação de serviço e coleta de evidências digitais.',
      date: '2024-10-28',
      category: 'Cybersecurity',
      readTime: '8 min',
      tags: ['DDoS', 'Forense de Rede', 'Logs', 'Mitigação'],
      featured: false,
      views: 1456,
      difficulty: 'Avançado',
      icon: Shield
    ...
    {
      id: 5,
      title: 'Rastreamento de Transações Bitcoin: Técnicas Avançadas',
      excerpt: 'Métodos profissionais para análise de blockchain Bitcoin e identificação de padrões suspeitos em investigações financeiras.',
      date: '2024-09-15',
      category: 'Blockchain Analysis',
      readTime: '10 min',
      tags: ['Bitcoin', 'Blockchain', 'OSINT', 'Mixing'],
      featured: false,
      views: 4289,
      difficulty: 'Expert',
      icon: TrendingUp
    ...
    {
      id: 6,
      title: 'Perícia em Dispositivos Android: Extração Forense',
      excerpt: 'Guia completo para extração e análise forense de dispositivos Android usando ferramentas profissionais certificadas.',
      date: '2024-08-22',
      category: 'Mobile Forensics',
      readTime: '12 min',
      tags: ['Android', 'Mobile', 'Extração', 'UFED'],
      featured: false,
      views: 2134,
      difficulty: 'Intermediário',
      icon: Users
